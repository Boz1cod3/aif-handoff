...
| `AIF_RUNTIME_ANTIGRAVITY_ENABLED`                      | boolean | `false`                        | Off-by-default rollout flag for the Google Antigravity runtime adapter. When `false`, the Antigravity adapter is excluded from registry bootstrap and does not participate in default project initialization. Set to `true` to enable Antigravity runtime registration and initialization                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
